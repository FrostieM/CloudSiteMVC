...
namespace cloudSiteMvc
{
    ...
    {
        public string Name { get; set; }
        public int AppsNum => Apps?.Count() ?? 0;
    ...
    public class SpreadsheetReader
    {
        ...
        private readonly AccessProvider _accessProvider = new AccessProvider(AccessType.ServiceAccount);
        ...
        {
            var compNames = _accessProvider.GetSheetNames();
        ...
        {
            return _accessProvider.ReadEntries(sheetName);
        }
